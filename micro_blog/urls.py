...
urlpatterns = patterns('micro_blog.views',
    ...
    url(r'^blog-comments/$', 'blog_comments', name='blog_comments'),
    url(r'^comment-status/(?P<comment_id>[-\w]+)/$', 'comment_status', name='comment_status'),
    url(r'^delete-comments/(?P<comment_id>[-\w]+)/$', 'delete_blog_comments', name='delete_blog_comments'),
    url(r'^edit-comment-status/(?P<comment_id>[-\w]+)/$', 'edit_comment', name='edit_comment'),
    url(r'^delete/blog-comment/(?P<comment_id>[-\w]+)/$', 'delete_comment', name='delete_post'),
    ...
    url(r'^edit-blog-post/(?P<blog_slug>[-\w]+)/$', 'edit_post', name='edit_post'),
