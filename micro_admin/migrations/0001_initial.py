    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(help_text='The groups this user belongs to. A user will get all permissions granted to each of his/her group.', related_name=b'user_groups', verbose_name='groups', to='auth.Group', blank=True)),
                ('user_permissions', models.ManyToManyField(help_text=b'Specific permissions for this user.', related_name=b'user_permissions', verbose_name='user permissions', to='auth.Permission', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_field', models.CharField(max_length=100, null=True, blank=True)),
