...
def users(request):
    ...
    return render_to_response('admin/useraccount/user-list.html',{'user_list':users})
...
def new_user(request):
    if request.method == 'POST':
        ...
        return render_to_response('admin/useraccount/user-new.html',{'user_roles':user_roles,'csrf_token':c['csrf_token']})
